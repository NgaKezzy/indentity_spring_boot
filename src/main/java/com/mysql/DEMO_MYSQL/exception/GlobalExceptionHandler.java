...
public class GlobalExceptionHandler {
  ...
  ResponseEntity<ApiResponse<Void>> handlingAuthorizationDeniedException(
  ...
  ResponseEntity<ApiResponse<Void>> handlingAuthenticationException(
  ...
  ResponseEntity<ApiResponse<Void>> handlingBadCredentialsException(
  ...
  ResponseEntity<ApiResponse<Void>> handlingUsernameNotFoundException(
  ...
  ResponseEntity<ApiResponse<Void>> handlingConstraintViolationException(
  ...
  ResponseEntity<ApiResponse<Void>> handlingNoHandlerFoundException(
  ...
  ResponseEntity<ApiResponse<Void>> handlingMissingRequestHeaderException(
  ...
  ResponseEntity<ApiResponse<Void>> handlingMissingPathVariableException(
  ...
  ResponseEntity<ApiResponse<Void>> handlingIllegalArgumentException(
