...
public enum ErrorCode {
    ...
    USERNAME_INVALID(1004, "Username must be {min} characters and cannot be blank", HttpStatus.BAD_REQUEST),
    ...
    EXTERNAL_SERVICE_UNAVAILABLE(1092, "External service unavailable", HttpStatus.SERVICE_UNAVAILABLE),
