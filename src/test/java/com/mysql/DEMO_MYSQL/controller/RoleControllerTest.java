...
class RoleControllerTest {
    ...
    void updateRole_success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/roles/{name}", "ADMIN")
                        .contentType(MediaType.APPLICATION_JSON_VALUE)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.data.description").value("Updated administrator"));
    ...
    void delete_success() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/roles/{name}", "ADMIN"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.code").value(1000))
                .andExpect(MockMvcResultMatchers.jsonPath("$.success").value(true))
