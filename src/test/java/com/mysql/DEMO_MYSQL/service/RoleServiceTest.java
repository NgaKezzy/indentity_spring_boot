...
class RoleServiceTest {
  ...
  void create_validRequest_success() {
    ...
    Mockito.when(permissionRepository.findAllById(request.getPermissions()))
  ...
  void updateRole_roleFound_success() {
    RoleUpdateRequest updateRequest =
        RoleUpdateRequest.builder().description("Updated").permissions(Set.of("USER_READ")).build();
  ...
  void updateRole_roleNotFound_fail() {
    ...
    AppException exception =
        assertThrows(AppException.class, () -> roleService.updateRole(updateRequest, "UNKNOWN"));
